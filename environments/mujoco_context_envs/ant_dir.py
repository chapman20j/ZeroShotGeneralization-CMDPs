...
class AntDir(AntEnv):
    ...
    def _get_rew(self, xy_velocity: float, action):
        goal_reward = (
            np.dot(self.context_values, xy_velocity) * self._forward_reward_weight
        )
        ...
        drdp = xy_velocity * self._forward_reward_weight
